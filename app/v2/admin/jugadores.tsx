...
const styles = StyleSheet.create({
  ...
  card: { flexDirection: 'row', alignItems: 'center', backgroundColor: C.surface, padding: 14, borderRadius: R.lg, borderWidth: 1.5, borderColor: C.ink, gap: 14, ...SHADOW.sm },
  avatar: { width: 50, height: 50, backgroundColor: C.brandWash, borderWidth: 1.5, borderColor: C.ink, alignItems: 'center', justifyContent: 'center' },
