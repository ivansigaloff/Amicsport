...
const styles = StyleSheet.create({
  ...
  pill: { paddingHorizontal: 14, paddingVertical: 7, borderRadius: R.pill, backgroundColor: C.surface, borderWidth: 1.5, borderColor: C.ink },
  pillActive: { backgroundColor: C.ink800, borderColor: C.ink },
  ...
  card: { backgroundColor: C.surface, borderRadius: R.lg, padding: S.lg, borderWidth: 1.5, borderColor: C.ink, ...SHADOW.sm },
  ...
  amount: { fontSize: 16, fontFamily: FONTS.monoMedium, color: C.text },
