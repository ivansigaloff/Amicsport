...
const styles = StyleSheet.create({
  ...
  avatar: { width: 92, height: 92, backgroundColor: '#fff', borderWidth: 2, borderColor: C.ink, alignItems: 'center', justifyContent: 'center', ...SHADOW.md },
  avatarText: { color: C.text, fontSize: 42, fontFamily: FONTS.black },
  name: { color: '#fff', fontSize: 26, fontFamily: FONTS.black, marginTop: S.md, letterSpacing: 0.8, textTransform: 'uppercase' },
  email: { color: 'rgba(255,255,255,0.7)', fontSize: 13, fontFamily: FONTS.medium, marginTop: 2 },
  adminTag: { flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: C.accent, borderWidth: 1.5, borderColor: C.ink, paddingHorizontal: 10, paddingVertical: 4, borderRadius: R.pill, marginTop: 10 },
  adminTagText: { color: C.ink, fontFamily: FONTS.extraBold, fontSize: 10, letterSpacing: 0.8 },
  body: { paddingHorizontal: S.lg, marginTop: -18 },
  statCard: { alignItems: 'center' },
  stat: { alignItems: 'center' },
  statNum: { fontSize: 36, fontFamily: FONTS.black, color: C.brandDeep },
  statLabel: { fontSize: 11, fontFamily: FONTS.monoMedium, color: C.textMuted, textTransform: 'uppercase', letterSpacing: 1.2, marginTop: 4 },
  row: { flexDirection: 'row', alignItems: 'center', backgroundColor: C.surface, padding: 14, borderRadius: R.md, borderWidth: 1.5, borderColor: C.ink, gap: 14, ...SHADOW.sm },
