...
const styles = StyleSheet.create({
  ...
  reserveBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: COLORS.PRIMARY, paddingVertical: 14, paddingHorizontal: 24, borderRadius: 0, gap: 8 },
  ...
  smallIconBtn: { width: 48, height: 48, borderRadius: 0, justifyContent: 'center', alignItems: 'center' },
  deadlineText: { fontSize: 10, color: COLORS.TEXT_LIGHT, marginTop: 4, textAlign: 'right', fontStyle: 'italic' },
  paidBadge: { flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: '#D1FAE5', borderRadius: 0, paddingHorizontal: 8, paddingVertical: 3, marginBottom: 6, alignSelf: 'flex-end' },
